...
export default function PostCard(props) {
  const { postData, currUserPosts, handleDeletePost, handleUpdatePost } = props;
  let isAdmin = false;
  if (currUserPosts.includes(postData._id)) {
    isAdmin = true;
  }
  return (
    <div className="relative">
      <div className="card w-96 h-4/5 bg-base-100 shadow-xl">
        ...
        {isAdmin && (
          <div className="absolute left-0 top-0 w-full h-full bg-black bg-opacity-25 opacity-0 transition-opacity duration-300 hover:opacity-100">
            <ul className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center gap-5">
              ...
              <li>
                <button onClick={() => handleDeletePost(postData)}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="white"
